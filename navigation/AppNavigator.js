...
import Profile2 from "../authentication/Profile2";
import Profile3 from "../authentication/Profile3";
import Profile4 from "../authentication/Profile4";
...
export default function AppNavigator() {
  return (
    <Stack.Navigator initialRouteName="SignIn">
      ...
      <Stack.Screen
        name="PreProfileStep1"
        component={Profile1}
        options={{ title: "Setting", headerShown: null }}
      />
      <Stack.Screen
        name="PreProfileStep2"
        component={Profile2}
        options={{ title: "Setting", headerShown: null }}
      />
      <Stack.Screen
        name="PreProfileStep3"
        component={Profile3}
        options={{ title: "Setting", headerShown: null }}
      />
      <Stack.Screen
        name="PreProfileStep4"
        component={Profile4}
        options={{ title: "Setting", headerShown: null }}
      />
